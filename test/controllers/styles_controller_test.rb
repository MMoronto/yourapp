...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { address: @style.address, image_url: @style.image_url, price: @style.price, rating: @style.rating, stylist: @style.stylist } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { address: @style.address, image_url: @style.image_url, price: @style.price, rating: @style.rating, stylist: @style.stylist } }
